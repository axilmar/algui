...
static void init() {
    ALG_STATIC_INIT({
        ...
        alg_add_enum_value(&msg_enum, ALG_MSG_INSERTED              , "ALG_MSG_INSERTED"              );
        alg_add_enum_value(&msg_enum, ALG_MSG_CHILD_INSERTED        , "ALG_MSG_CHILD_INSERTED"        );
        alg_add_enum_value(&msg_enum, ALG_MSG_Z_ORDER_CHANGED       , "ALG_MSG_Z_ORDER_CHANGED"       );
        alg_add_enum_value(&msg_enum, ALG_MSG_CHILD_Z_ORDER_CHANGED , "ALG_MSG_CHILD_Z_ORDER_CHANGED" );
        alg_add_enum_value(&msg_enum, ALG_MSG_REMOVED               , "ALG_MSG_REMOVED"               );
        alg_add_enum_value(&msg_enum, ALG_MSG_CHILD_REMOVED         , "ALG_MSG_CHILD_REMOVED"         );
        alg_add_enum_value(&msg_enum, ALG_MSG_GEOMETRY_CHANGED      , "ALG_MSG_GEOMETRY_CHANGED"      );
        ...
        alg_add_enum_value(&msg_enum, ALG_MSG_TREE_GOT_FOCUS        , "ALG_MSG_TREE_GOT_FOCUS"        );
        alg_add_enum_value(&msg_enum, ALG_MSG_LOST_FOCUS            , "ALG_MSG_LOST_FOCUS"            );
        alg_add_enum_value(&msg_enum, ALG_MSG_TREE_LOST_FOCUS       , "ALG_MSG_TREE_LOST_FOCUS"       );
